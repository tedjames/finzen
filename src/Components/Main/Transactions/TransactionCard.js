  ...
  render() {
    return (
      <View style={styles.transactionContainer}>
        <TouchableOpacity style={styles.transactionCard} activeOpacity={0.4} onPress={this.handlePress}>
          ...
          <View style={styles.transactionData}>
            ...
            <View style={styles.amountContainer}>
              ...
              <Text style={this.props.neg ? styles.negAmount : styles.amount}>{this.props.amount}</Text>
            </View>
          </View>
        </TouchableOpacity>
      </View>

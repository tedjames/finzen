      ...
      <GradientView colors={['#fff', '#f5f5f8']}>
        <ScrollView>
          <View>
            ...
            <Header text="Feedback" loading={loading} />
          </View>

          <Form height={450} loading={loading}>
            <ActionForm disabled={disableButtons} label="Subject" value={this.state.problemType} placeholder="Please choose one..." onPress={() => this.setState({ modalOpen: true })} dropdown />
